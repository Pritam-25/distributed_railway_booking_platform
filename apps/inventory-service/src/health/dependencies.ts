 ...
 *
 * `inventory-service` readiness probes. Each adapter is a `HealthDependency`
 ...
 * `apps/inventory-service/src/services/health.service.ts`.
 *
 * `inventory-service` probes `database` (Prisma), `redis`, and `kafka`.
 */
