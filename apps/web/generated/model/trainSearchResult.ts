 ...
 */
import type { AvailableSeats } from "./availableSeats"
import type { FareRange } from "./fareRange"
import type { TrainSearchResultFrom } from "./trainSearchResultFrom"
import type { TrainSearchResultStatus } from "./trainSearchResultStatus"
import type { TrainSearchResultTo } from "./trainSearchResultTo"
...
export interface TrainSearchResult {
  ...
  trainName: string
  category: string
  from: TrainSearchResultFrom
  to: TrainSearchResultTo
  /** @nullable */
  durationMinutes: number | null
  distanceKm: number
  fareRange: FareRange
  availableSeats: AvailableSeats
  status: TrainSearchResultStatus
