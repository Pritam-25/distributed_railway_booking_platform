...
export type CreateBookingResponseStatus =
  (typeof CreateBookingResponseStatus)[keyof typeof CreateBookingResponseStatus]

export const CreateBookingResponseStatus = {
  PENDING: "PENDING",
